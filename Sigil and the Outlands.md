...
*"Sure, Sigil's got everything you could ever want–if you can find it! My advice? Hire a tout to do your shopping. Last time I visited the Great Bazaar, it took me so long to find my way out that my avocados went bad. What a mess."*— Digny Vots, Market Ward shopper<table class="rd__b-special rd__b-data  rd__b-data--stats">
		<thead>
			...
			<td colspan="6" data-rd-tag="table" data-rd-uid="Sigil Market Ward Encounters|SatO" data-rd-page="tables.html" data-rd-source="SatO" data-rd-hash="sigil%20market%20ward%20encounters_sato" data-rd-name="Sigil Market Ward Encounters" data-rd-display-name="Sigil Market Ward Encounters" data-rd-style="" data-rd-entry-data="{}">
				<i>Loading <a href="tables.html#sigil%20market%20ward%20encounters_sato"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="tables.html" data-vet-source="SatO" data-vet-hash="sigil%20market%20ward%20encounters_sato" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Sigil Market Ward Encounters</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
...
<table class="rd__b-special rd__b-data  rd__b-data--stats">
		<thead>
			...
			<td colspan="6" data-rd-tag="table" data-rd-uid="Sigil Undersigil Encounters|SatO" data-rd-page="tables.html" data-rd-source="SatO" data-rd-hash="sigil%20undersigil%20encounters_sato" data-rd-name="Sigil Undersigil Encounters" data-rd-display-name="Sigil Undersigil Encounters" data-rd-style="" data-rd-entry-data="{}">
				<i>Loading <a href="tables.html#sigil%20undersigil%20encounters_sato"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="tables.html" data-vet-source="SatO" data-vet-hash="sigil%20undersigil%20encounters_sato" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Sigil Undersigil Encounters</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
...
<table class="rd__b-special rd__b-data  rd__b-data--stats">
		<thead>
			...
			<td colspan="6" data-rd-tag="table" data-rd-uid="Sigil General Encounters|SatO" data-rd-page="tables.html" data-rd-source="SatO" data-rd-hash="sigil%20general%20encounters_sato" data-rd-name="Sigil General Encounters" data-rd-display-name="Sigil General Encounters" data-rd-style="" data-rd-entry-data="{}">
				<i>Loading <a href="tables.html#sigil%20general%20encounters_sato"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="tables.html" data-vet-source="SatO" data-vet-hash="sigil%20general%20encounters_sato" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Sigil General Encounters</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
